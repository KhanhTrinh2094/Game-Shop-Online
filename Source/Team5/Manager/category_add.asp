...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Category (CategoryName, CategoryDescription, Status) VALUES (?, ?, 1)" 
...
rsAdd_cmd.ActiveConnection = MM_CONNECT_STRING
rsAdd_cmd.CommandText = "SELECT * FROM dbo.Category" 
