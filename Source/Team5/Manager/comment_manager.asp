...
rsComment_cmd.CommandText = "SELECT a.*, b.MemberID, b.MemberName, c.GameID, c.GameTitle FROM dbo.Comment a JOIN Member b ON a.MemberID = b.MemberID JOIN Game c ON a.GameID = c.GameID ORDER BY CommentID DESC" 
                ...
                <div class="static-content-wrapper">
                    <div class="static-content">
                                            ...
                                            <div class="panel-body panel-no-padding">
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="colreorder">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                          <td><%=(rsComment.Fields.Item("CommentID").Value)%></td>
                                                          <td><a href="member_detail.asp?id=<%=(rsComment.Fields.Item("MemberID").Value)%>"><%=(rsComment.Fields.Item("MemberName").Value)%></a></td>
                                                          <td><%=(rsComment.Fields.Item("GameTitle").Value)%></td>
                                                          <td><%=(rsComment.Fields.Item("CommentTime").Value)%></td>
                                                          <td style="text-align:center"><a data-toggle="modal" href="#detail-<%=(rsComment.Fields.Item("CommentID").Value)%>"><button class="btn-default btn" type="button">Detail</button></a> <a href="javascript:deleteID('<%=(rsComment.Fields.Item("CommentID").Value)%>')"><button class="btn-default btn">Delete</button></a></td>
                                                        </tr>
                                                        <% 
                        ...
                        <%
							...
							While ((Repeat1__numRows <> 0) AND (NOT rsComment.EOF))
						%>
                                <div class="modal fade" id="detail-<%=(rsComment.Fields.Item("CommentID").Value)%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                <h2 class="modal-title">Comment Detail</h2>
                                            </div>
                                            <div class="modal-body">
                                            	<form class="form-horizontal">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9"><%=(rsComment.Fields.Item("CommentID").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Game : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9"><%=(rsComment.Fields.Item("GameTitle").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Member : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9" style="max-width:100%; word-wrap:break-word;"><%=(rsComment.Fields.Item("MemberName").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Time : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9" style="max-width:100%; word-wrap:break-word;"><%=(rsComment.Fields.Item("CommentTime").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Detail : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9" style="max-width:100%; word-wrap:break-word;"><%=(rsComment.Fields.Item("CommentDetail").Value)%></div>
                                                  </div>
                                                </form>
                                            </div>
                        ...
                        <script type="text/javascript">
							function deleteID(id){
								if(confirm("Are you sure you want to delete this comment ?")){
									window.location = "comment_manager.asp?delete=" + id;
								}
							}
						</script>
						<!-- InstanceEndEditable -->
