...
<%
Dim rsFBDetail__MMColParam
rsFBDetail__MMColParam = "1"
If (Request.QueryString("id") <> "") Then 
  rsFBDetail__MMColParam = Request.QueryString("id")
End If
%>
<%
Dim rsFBDetail
Dim rsFBDetail_cmd
Dim rsFBDetail_numRows

Set rsFBDetail_cmd = Server.CreateObject ("ADODB.Command")
rsFBDetail_cmd.ActiveConnection = MM_CONNECT_STRING
rsFBDetail_cmd.CommandText = "SELECT * FROM dbo.Feedback WHERE FeedbackID = ?" 
rsFBDetail_cmd.Prepared = true
rsFBDetail_cmd.Parameters.Append rsFBDetail_cmd.CreateParameter("param1", 5, 1, -1, rsFBDetail__MMColParam) ' adDouble

Set rsFBDetail = rsFBDetail_cmd.Execute
rsFBDetail_numRows = 0
%>
<%
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Member : </label>
                                                                <div class="col-sm-1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    Xin chào. Đây là nội dung feedback. Cảm ơn bạn đã xem
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
