...
If Request.QueryString("delete") <> "" Then
	...
	Dim MM_abortEdit
	MM_abortEdit = false
	Set FBID = Request.QueryString("delete")
	
	If (Not MM_abortEdit) Then

		Set MM_editCmd = Server.CreateObject ("ADODB.Command")
		MM_editCmd.ActiveConnection = MM_CONNECT_STRING
		MM_editCmd.CommandText = "DELETE FROM dbo.Feedback WHERE FeedbackID = ?"
		MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param1", 5, 1, -1, FBID) ' adDouble
		MM_editCmd.Execute
		MM_editCmd.ActiveConnection.Close

		Dim MM_editRedirectUrl
		MM_editRedirectUrl = "feedback_manager.asp"
...
rsFeedback_cmd.CommandText = "SELECT a.*, b.MemberName FROM dbo.Feedback a JOIN Member b ON a.MemberID = b.MemberID ORDER BY FeedbackID DESC" 
...
Repeat1__numRows = -1
Repeat1__index = 0
rsFeedback_numRows = rsFeedback_numRows + Repeat1__numRows
%>
                ...
                <div class="static-content-wrapper">
                    <div class="static-content">
                                        ...
                                        <div class="panel panel-default" id="panel-reorder">
                                            ...
                                            <div class="panel-body panel-no-padding">
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="colreorder">
                                                    ...
                                                    <tbody>
                                                    <% While ((Repeat1__numRows <> 0) AND (NOT rsFeedback.EOF)) %>
                                                        <tr>
                                                          <td><%=(rsFeedback.Fields.Item("FeedbackID").Value)%></td>
                                                          <td><a href="member_detail.asp?id=<%=(rsFeedback.Fields.Item("MemberID").Value)%>"><%=(rsFeedback.Fields.Item("MemberName").Value)%></a></td>
                                                          <td style="max-width:100px; word-wrap:break-word"><%=(rsFeedback.Fields.Item("FeedbackTitle").Value)%></td>
                                                          <td style="max-width:300px; word-wrap:break-word"><%=Mid(rsFeedback.Fields.Item("FeedbackDetail").Value, 1, 50)%>...</td>
                                                          <td align="center" style="width: 160px;"><a data-toggle="modal" href="#detail-<%=(rsFeedback.Fields.Item("FeedbackID").Value)%>"><button class="btn-default btn" type="button">Detail</button></a> <a href="javascript:deleteFB(<%=(rsFeedback.Fields.Item("FeedbackID").Value)%>)"><button class="btn-default btn">Delete</button></td>
                                                        </tr>
                                                    <% 
                        ...
                        <%
							...
							While ((Repeat1__numRows <> 0) AND (NOT rsFeedback.EOF))
						%>
                                <div class="modal fade" id="detail-<%=(rsFeedback.Fields.Item("FeedbackID").Value)%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-body">
                                            	<form class="form-horizontal">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9"><%=(rsFeedback.Fields.Item("FeedbackID").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Member : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9"><a href="member_detail.asp?id=<%=(rsFeedback.Fields.Item("MemberID").Value)%>"><%=(rsFeedback.Fields.Item("MemberName").Value)%></a></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Title : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9" style="max-width:100%; word-wrap:break-word;"><%=(rsFeedback.Fields.Item("FeedbackTitle").Value)%></div>
                                                  </div>
                                                  <div class="form-group">
                                                    <div class="col-sm-2">Detail : </div>
                                                    <div class="col-sm-1"></div>
                                                    <div class="col-sm-9" style="max-width:100%; word-wrap:break-word;"><%=(rsFeedback.Fields.Item("FeedbackDetail").Value)%></div>
                                                  </div>
                                                </form>
                                            </div>
                            ...
                            <script type="text/javascript">
								function deleteFB(id){
									if(confirm("Are you sure you want to delete this feedback ?")){
										window.location = "feedback_manager.asp?delete=" + id;
									}
								}
							</script>
						<!-- InstanceEndEditable -->
