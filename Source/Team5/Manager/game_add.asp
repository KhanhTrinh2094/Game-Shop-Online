...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Game (GameTitle, GameImage, CategoryID, GamePrice, GameDetail, Status) VALUES (?, ?, ?, ?, ?, 1)" 
                            	...
                            	<div class="row">
                                    <div class="col-sm-12">
                                        <div class="panel panel-midnightblue">
                                            ...
                                            <form ACTION="<%=MM_editAction%>" name="form1" METHOD="POST" onSubmit="return kt();" class="form-horizontal">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        	...
                                                        	<div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="title" placeholder="Game Title" value="" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
...
%>
                                                                	  <option value="<%=(rsCategory.Fields.Item("CategoryID").Value)%>" <%If (Not isNull((rsCategory.Fields.Item("CategoryID").Value))) Then If (CStr(rsCategory.Fields.Item("CategoryID").Value) = CStr((rsCategory.Fields.Item("CategoryID").Value))) Then Response.Write("selected=""selected""") : Response.Write("")%> ><%=(rsCategory.Fields.Item("CategoryName").Value)%></option>
                                                                	  <%
  rsCategory.MoveNext()
Wend
...
%>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="price" placeholder="Game Price" value="" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <textarea name="detail" placeholder="Game Detail" class="form-control"></textarea>
                                                                </div>
                                                            </div>
