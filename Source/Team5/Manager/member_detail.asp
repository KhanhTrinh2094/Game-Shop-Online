...
If (Request.QueryString("id") <> "") Then 
  rsMember__MMColParam = Request.QueryString("id")
End If
%>
<%
Dim rsMember
...
If rsMember.EOF then
	Response.Redirect("member_manager.asp")
end if
%>
<%
                                                    ...
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        <form class="form-horizontal">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Member ID : </label>
                                                                <div class="col-sm-1">
                                                                    
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("MemberID").Value%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Username : </label>
                                                                <div class="col-sm-1">
                                                                    
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("Username").Value%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Fullname : </label>
                                                                <div class="col-sm-1">
                                                                    
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("MemberName").Value%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Address : </label>
                                                                <div class="col-sm-1">
                                                                    
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("MemberAddress").Value%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("MemberMobile").Value%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label" style="    padding-top: 0px;" >Email : </label>
                                                                <div class="col-sm-1">
                                                                    
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <%=rsMember.Fields.Item("MemberEmail").Value%>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row">
                                                        <div class="col-sm-8 col-sm-offset-2">
                                                            <a href="member_manager.asp"><button type="button" class="btn-default btn">Back</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
