...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.News (NewsTitle, NewsImage, NewsDescription, NewsDetail, NewsDate) VALUES (?, ?, ?, ?, GETDATE())" 
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                	<textarea class="form-control" name="description" placeholder="News Description"></textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <textarea class="form-control" placeholder="News Detail" name="detail"></textarea>
                                                                </div>
                                                            </div>
