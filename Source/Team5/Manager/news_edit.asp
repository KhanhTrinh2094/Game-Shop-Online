...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE dbo.News SET NewsTitle = ?, NewsImage = ?, NewsDescription = ?, NewsDetail = ? WHERE NewsID = ?" 
    MM_editCmd.Prepared = true
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param1", 202, 1, 200, Request.Form("title")) ' adVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param2", 201, 1, 100, Request.Form("txtLink")) ' adLongVarChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param3", 201, 1, 300, Request.Form("description")) ' adLongVarChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param4", 203, 1, 1073741823, Request.Form("detail")) ' adLongVarWChar
    ...
    MM_editRedirectUrl = "news_manager.asp"
    If (Request.QueryString <> "") Then
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="horizontal-form">
                                                        	...
                                                        	<div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                  <input type="text" class="form-control" name="title" placeholder="News Title" value="<%=(rsNews.Fields.Item("NewsTitle").Value)%>" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                               	  <img src="../upload/<%=(rsNews.Fields.Item("NewsImage").Value)%>" style="width:50px; height:50px;" />
                                                                    <input type="file" name="txtImage" id="txtImage" onchange="cut_string();">
                                  									<input type="hidden" name="txtLink" id="txtLink" value="<%=(rsNews.Fields.Item("NewsImage").Value)%>" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                               	  <textarea class="form-control" placeholder="News Description" name="description"><%=(rsNews.Fields.Item("NewsDescription").Value)%></textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <textarea class="form-control" placeholder="News Detail" name="detail"><%=(rsNews.Fields.Item("NewsDetail").Value)%></textarea>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row">
                                                        <div class="col-sm-8 col-sm-offset-2">
                                                            ...
                                                            <a href="news_manager.asp"><button type="button" class="btn-default btn">Back</button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="hidden" name="MM_update" value="form1">
                                            <input type="hidden" name="MM_recordId" value="<%= rsNews.Fields.Item("NewsID").Value %>">
                                            </form>
                                        </div>
                                    </div>
                                </div>
