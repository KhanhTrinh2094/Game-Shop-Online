...
If Request.QueryString("delete") <> "" Then
	...
	If (Not MM_abortEdit) Then
		...
		MM_editCmd.CommandText = "DELETE FROM News WHERE NewsID = ?"
...
rsNews_cmd.CommandText = "SELECT * FROM dbo.News ORDER BY NewsID DESC" 
                                        ...
                                        <div class="panel panel-default" id="panel-reorder">
                                            <div class="panel-heading">
                                                ...
                                                <div class="panel-ctrls">
                                                	<i class="separator"></i>
                                                	<a href="news_add.asp"><button class="btn-default btn">Add New</button></a>
                                                </div>
                                            </div>
                                            <div class="panel-body panel-no-padding">
                                              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="colreorder">
                                                    ...
                                                    <% While ((Repeat1__numRows <> 0) AND (NOT rsNews.EOF)) %>
                                                      <tr>
                                                        <td><%=(rsNews.Fields.Item("NewsID").Value)%></td>
                                                        <td><img src="../upload/<%=(rsNews.Fields.Item("NewsImage").Value)%>"  style="width:50px; height:50px;" /></td>
                                                        <td style="max-width:100px; word-wrap:break-word;"><%=(rsNews.Fields.Item("NewsTitle").Value)%></td>
                                                        <td style="max-width:300px; word-wrap:break-word;"><%=(rsNews.Fields.Item("NewsDescription").Value)%></td>
                                                        <td><%=(rsNews.Fields.Item("NewsDate").Value)%></td>
                                                        <td align="center"><a href="news_edit.asp?id=<%=(rsNews.Fields.Item("NewsID").Value)%>"><button class="btn-default btn">Edit</button></a> <a href="javascript:deleteID('<%=(rsNews.Fields.Item("NewsID").Value)%>')"><button class="btn-default btn">Delete</button></a></td>
                                                      </tr>
                                                      <% 
						...
						<script type="text/javascript">
							function deleteID(id){
								if(confirm("Are you sure you want to delete this news ?")){
									window.location = "news_manager.asp?delete=" + id;
								}
							}
						</script>
						<!-- InstanceEndEditable -->
