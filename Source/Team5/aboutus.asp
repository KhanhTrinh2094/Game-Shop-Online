						...
						<div id="content-wrap" class="default">
 							<div class="row">
    							<div class="small-12 columns primary">
									<p>
                                    	Chào mừng bạn đến với Project Game Website của nhóm 5.<br/> Website này ra đời với mong muốn đưa lại cho bạn sự tiện dụng, tiện nghi và đáp ứng nhu cầu mua sắm của bạn.
                                    </p>
                                    <p>Nhóm 5 gồm các thành viên sau :
                                    </p>
                                    <div>
                                    	<ul>
                                        	<li>
                                            	<span>Lê Đức Anh (Leader)</span>
                                                <br/>
                                            </li>
                                            <li>
                                            	<span>Nguyễn Võ Thanh Huy</span>
                                                <br />
                                            </li>
                                            <li>
                                            	<span>Lâm Minh Khanh</span>
                                                <br />
                                            </li>
                                            <li>
                                            	<span>Trần Ngọc Thiện</span>
                                                <br />
                                            </li>
                                        </ul>
                                     </div>
