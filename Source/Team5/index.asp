...
If (Request("MM_EmptyValue") <> "") Then 
  rsGame__MMColParam = Request("MM_EmptyValue")
End If
%>
<%
Dim rsGame
...
rsGame_cmd.CommandText = "SELECT * FROM dbo.Game WHERE Status = ? ORDER BY GameID DESC" 
rsGame_cmd.Prepared = true
rsGame_cmd.Parameters.Append rsGame_cmd.CreateParameter("param1", 11, 1, -1, rsGame__MMColParam) ' adBoolean
                                ...
                                <div class="slides-wrap">
                                    <div class="bx-wrapper" style="max-width: 100%;">
                                        <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 393px;">
											<ul id="index-slides" class="bx-slider slides" data-autoplay="true" data-transition="horizontal" data-duration="5000" data-transition-duration="600" style="width: 615%; position: relative; transition-timing-function: cubic-bezier(0.48, 0.43, 0.07, 1); transition-duration: 0s; transform: translate3d(-3429px, 0px, 0px);">
												<li class="slide bx-clone" style="float: left; list-style: none; position: relative; width: 1143px; opacity: 1;">
													<img src="<%=USER_TEMPLATE%>/images/slider/1.jpg" style="width: 1164px; height: 400px;" />
												</li />
                                                <li class="slide" style="float: left; list-style: none; position: relative; width: 1143px; opacity: 1;">
                                                    <a href="">
                                                        <img src="<%=USER_TEMPLATE%>/images/slider/2.jpg" style="width: 1164px; height: 400px;" />
                                                    </a>
                                                </li>
                                                <li class="slide" style="float: left; list-style: none; position: relative; width: 1143px; opacity: 1;">
                                                    <a href="">
                                                        <img src="<%=USER_TEMPLATE%>/images/slider/3.jpg" style="width: 1164px; height: 400px;" />
                                                    </a>
                                                </li>
                                                <li class="slide" style="float: left; list-style: none; position: relative; width: 1143px; opacity: 1;">
                                                    <a href="">
                                                        <img src="<%=USER_TEMPLATE%>/images/slider/4.jpg" style="width: 1164px; height: 400px;" />
                                                    </a>
                                                </li>
                                                <li class="slide" style="float: left; list-style: none; position: relative; width: 1143px; opacity: 1;">
                                                	<img src="<%=USER_TEMPLATE%>/images/slider/5.jpg" style="width: 1164px; height: 400px;" />
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="promo-boxes">
                                        <div class="row">
                                            <div class="medium-4 columns">
                                                <a href="" title=""><img src="<%=USER_TEMPLATE%>/images/banner/1.jpg" alt=""></a />
                                            </div>
                                            <div class="medium-4 columns">
                                                <a href="" title=""><img src="<%=USER_TEMPLATE%>/images/banner/2.jpg" alt=""></a />
                                            </div>
                                            <div class="medium-4 columns">
                                                <a href="" title=""><img src="<%=USER_TEMPLATE%>/images/banner/3.png" alt=""></a />
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Page content -->
