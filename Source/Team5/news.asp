                                        ...
                                        <% While ((Repeat1__numRows <> 0) AND (NOT rsNews.EOF)) %>
											<div class="row">
                                              <div class="large-9 large-push-3 columns">
    												<header>
      													<h2 class="entry-title" style="word-wrap: break-word;">
        													<a href="newsDetail.asp?id=<%=(rsNews.Fields.Item("NewsID").Value)%>" title=""><%=(rsNews.Fields.Item("NewsTitle").Value)%></a>
      													</h2>
    												</header>
  													<!-- Article list -->
      												<div class="entry-summary">
    													<div>
    														<img src="upload/<%=(rsNews.Fields.Item("NewsImage").Value)%>" style="height:200px; width:310px;" />

                                                            </table>
                                                        </div>
                                                        <p class="more-link">
                                                          <a href="newsDetail.asp?id=<%=(rsNews.Fields.Item("NewsID").Value)%>" class="button" style="margin-top:20px;">Tìm hiểu thêm</a>
                                                        </p>
													</div>
  												</div>
