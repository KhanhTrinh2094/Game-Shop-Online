                          ...
                          <div class="row">
                            <div class="small-12 columns primary">
                            	<div style="display:inline-block">
                                	<div class="col-left">Username : </div><div class="col-right"><%=(rsMember.Fields.Item("Username").Value)%></div>
                                </div>
                                <div>
                                	<div class="col-left">Fullname : </div><div class="col-right"><%=(rsMember.Fields.Item("MemberName").Value)%></div>
                                </div>
                                <div>
                                	<div class="col-left">Address : </div><div class="col-right"><%=(rsMember.Fields.Item("MemberAddress").Value)%></div>
                                </div>
                                <div>
                                	<div class="col-left">Mobile : </div><div class="col-right"><%=(rsMember.Fields.Item("MemberMobile").Value)%></div>
                                </div>
                                <div>
                                	<div class="col-left">Email : </div><div class="col-right"><%=(rsMember.Fields.Item("MemberEmail").Value)%></div>
                                </div>
                                <div>
                                	<div class="col-left"><a href="editprofile.asp"><button class="btn-primary">Sửa thông tin</button></a></div><div class="col-right"><a href="changepass.asp"><button class="btn-primary">Đổi mật khẩu</button></a></div>
                                </div>
						    </div>
                          </div>
                        </div>
